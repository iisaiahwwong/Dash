...
// MARK: Corner Radius, Border Width, Border Color
@IBDesignable
extension UIView {
    @IBInspectable
...
extension UIView {
    ...
    func setGradientBackground(gradientLayer: inout CAGradientLayer, upperBound: UIColor, lowerBound: UIColor) {
        gradientLayer.cornerRadius = 5.0
        gradientLayer.frame = self.bounds
        gradientLayer.colors = [upperBound.cgColor, lowerBound.cgColor]
    ...
    func setGradientBackground(gradientLayer: inout CAGradientLayer, cornerRadius: CGFloat, upperBound: UIColor, lowerBound: UIColor, withImage image: CALayer) {
    ...
    func removeGradientBackground(gradientLayer: inout CAGradientLayer) {
