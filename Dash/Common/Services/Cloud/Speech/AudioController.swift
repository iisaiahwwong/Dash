...
protocol AudioControllerDelegate {
    /** Provides Callback to process audio from AudioController **/
...
class AudioController {
    ...
    // MARK: Instance
    private static let _audioInstance = AudioController()
    
    // MARK: Shared Instance
    static func audio() -> AudioController {
        return self._audioInstance
    }
...
func recordingCallback(
    ...
    guard let remoteIOUnit = AudioController.audio().remoteIOUnit else {
        return status
    }
    ...
    DispatchQueue.main.async {
        AudioController.audio().delegate.processAudio(data)
    }
